			...
			if (requester != null)
			{
				...
				if (accessTarget != null)
				{
					...
					EntityProperty property =
						accessTarget.GetOrCreateProperty(
														 name,
															requester.Guid, KnownPermissionGroups.InternalApiOnly,
															 value
														);
		...
		public void TransferProperty(EntityToken token, Guid target, string name, Guid newOwner)
		{
			...
			if (requester != null)
			{
				...
				if (propertyOwner != null)
				{
					...
					EntityProperty property =
						propertyOwner.TryGetProperty( name);
		...
		public AccessType AccessProperty(EntityToken token, Guid target, string name)
		{
			...
			if (requester != null)
			{
				...
				if (propertyTarget != null)
				{
					...
					EntityProperty property =
						propertyTarget.TryGetProperty(name);
