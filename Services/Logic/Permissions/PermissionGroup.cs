...
namespace DreamRecorder . Directory . Services . Logic . Permissions
{
	...
	public class PermissionGroup
	{
		...
		public ObservableHashSet <Permission> Permissions { get ; } =
			new ObservableHashSet <Permission> ( ) ;
		...
		public void Edit ( [NotNull] Directory . Logic . PermissionGroup permissionGroup )
		{
			...
			Entity newOwner =
				DirectoryServiceInternal . Current . DirectoryDatabase . FindEntity (
			...
			Permissions . RemoveWhere (
										permission
											=> ! permissionGroup . Permissions . Contains (
												permission ) ) ;
		...
		public AccessType Access ( Entity entity )
		{
			...
			HashSet <Permission> affectedPermission = Permissions .
													Where (
															perm
																=> DirectoryServiceInternal .
																	Current . DirectoryDatabase .
																	FindEntity ( perm . Target ) .
																	Contain ( entity ) ) .
													ToHashSet ( ) ;
