	...
	public class DirectoryDatabaseStorage : DbContext , IDirectoryDatabaseStorage
	{
		...
		protected override void OnConfiguring ( DbContextOptionsBuilder optionsBuilder )
		{
			optionsBuilder . UseSqlServer (
											"Data Source=cssqlserver.dreamry.org;Initial Catalog=DreamryDirectory;Integrated Security=True" ) ;
		}
		...
		protected override void OnModelCreating ( ModelBuilder modelBuilder )
		{
			...
			modelBuilder . Entity <DbPermissionGroup> ( ) .
							HasKey ( permissionGroup => permissionGroup . Guid ) ;
			...
			modelBuilder . Entity <DbGroupMember> ( ) .
							HasOne <DbEntity> ( ) .
							WithMany ( ) .
							HasForeignKey ( groupMember => groupMember . MemberGuid ) ;

			modelBuilder . Entity <DbProperty> ( ) .
							HasKey ( property => new { property . Target , property . Name , } ) ;
			modelBuilder . Entity <DbProperty> ( ) .
