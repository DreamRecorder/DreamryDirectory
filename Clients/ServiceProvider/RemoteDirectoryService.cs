...
namespace DreamRecorder.Directory.ServiceProvider
{
    ...
    public class RemoteDirectoryService : IDirectoryService
    {
        ...
        public RemoteDirectoryService((string HostName, int Port) server) : this(server.HostName, server.Port)
        {

        }

        public RemoteDirectoryService(string hostName, int port)
        {
            HostName = hostName;
            Port = port;
        }
