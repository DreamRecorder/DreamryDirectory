...
namespace DreamRecorder . Directory . Logic
{
	...
	public static class KnownEntities
	{
		...
		public static Guid AuthorizedEntities
			=> Guid . Parse ( "D7A1809A-2E3B-4BCD-8927-3E2D96751F1F" ) ;

		public static Guid SpecialGroups
			=> Guid . Parse ( "7C08B933-AE17-4879-9420-CFA209B9690A" ) ;

		public static Guid DirectoryServices
			=> Guid . Parse ( "020e0fc0-01af-470f-85ed-c1b497713c35" ) ;

		public static Guid LoginServices
